 ...
 * 
 */
package com.qbao.ai.resposity.redis.cache.aspect;
...
import com.qbao.ai.resposity.redis.common.AbstractBaseRedisClusterDao;
...
//            logger.info("cache hit for key:"+cacheKey);
    ...
    public static void main(String[] arg){
        ...
        Class clazz = String.class;
            ...
            System.out.println(JSON.parseObject(value+"",clazz));
